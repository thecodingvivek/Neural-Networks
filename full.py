...
net.SGD(list(zip(train_x, train_y)), 30, 10, 3.0, test_data=list(zip(testd_x, testd_y)))

# Test the network
tt = list(zip(testd_x, testd_y))
output = net.feedforward(tt[0][0])
print(f"Network output: {output}, Target: {tt[0][1]}")
